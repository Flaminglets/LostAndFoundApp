        ...
        <div key={props.id}>
            ...
            sx={{ padding: "0.5rem"}}>
                ...
                <CardActions className="user_card_buttons">
                    ...
                    sx={{[theme.breakpoints.down('sm')]: {padding: "1vw", fontSize: "2vw", height: "5vw", width: "12vw"}, backgroundColor: "#D2D4C8", color:"black", height: "1.6rem"}}
                    onClick={handleEditClick}>
                    Edit
                    </FlamingoEditButton>
                    <FlamingoFoundButton size="small" variant="contained" className="user_card_button user_card_button_found"
                    sx={{[theme.breakpoints.down('sm')]: {padding: "1vw", fontSize: "2vw", height: "5vw", width: "12vw"}, backgroundColor: "#5F7470", height: "1.6rem"}}
